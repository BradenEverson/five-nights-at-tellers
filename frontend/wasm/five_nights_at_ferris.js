...
export class Game {
     ...
     */
    tick() {
        const ret = wasm.game_tick(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    get_map() {
        const ret = wasm.game_get_map(this.__wbg_ptr);
     ...
     */
    toggle_left() {
        wasm.game_toggle_left(this.__wbg_ptr);
    }
    /**
    ...
    is_dead() {
        try {
            ...
            wasm.game_is_dead(retptr, this.__wbg_ptr);
    ...
    render() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.game_render(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('five_nights_at_ferris_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
